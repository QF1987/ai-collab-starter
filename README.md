...
> 多 Agent（Scout + Claude Code + Impl）协同研发的项目骨架。
...
- **8 个 prompt 模板**（`.ai/prompts/01-08-*.md`）——Scout / Claude / Impl 各阶段使用
...
1. 打开 `.ai/intake-templates.md`（Scout / Impl / Claude 任何 Agent 都能读）
